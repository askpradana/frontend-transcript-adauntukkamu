  ...
  <nav class="flex h-screen w-16 flex-col justify-between border-e bg-white">
    <div>
      ...
      <div class="border-t border-gray-100">
        <div class="px-2">
          <RouterLink to="/settings" class="py-4">
            <button
              href="#"
            ...
            >
              ...
              <span
                class="invisible absolute start-full top-1/2 ms-4 -translate-y-1/2 rounded bg-primary px-2 py-1.5 text-xs font-medium text-black group-hover:visible"
              >
                General
              </span>
            </button>
